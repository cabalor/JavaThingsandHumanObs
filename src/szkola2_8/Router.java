...
public class Router {
			...
			public void keyTyped(KeyEvent e) {
			    if (e.getKeyChar() == KeyEvent.VK_ENTER) {
			    	if(lista.isSelectionEmpty()) {
			    		JOptionPane.showMessageDialog(panel, "wybierz imie z listy", null, JOptionPane.INFORMATION_MESSAGE);
			    		taLow.setText("");
			    	} else {
			    		dispaly.appendText(lista.getSelectedValue() +" "+taLow.getText());
			    		taLow.setText("");
			        }
	...
	/*private String getName(JList scroll) {
		return scroll.getSelectedValue().toString();
	}*/
